    ...
    internal class Display
    {
        public void printBoard(Board myBoard)
        {
            ...
            Console.WriteLine("| {0} | {1} | {2} | {3} |       | {4} | {5} |",
                getVisual("*", myBoard.P1Row[3]), getVisual(" ", myBoard.P1Row[2]), getVisual(" ", myBoard.P1Row[1]), 
                getVisual(" ", myBoard.P1Row[0]), getVisual("*", myBoard.P1Row[5]), getVisual(" ", myBoard.P1Row[4]));
            Console.WriteLine("+---+---+---+---+---+---+---+---+");
            ...
            Console.WriteLine("+---+---+---+---+---+---+---+---+");
            Console.WriteLine("| {0} | {1} | {2} | {3} |       | {4} | {5} |",
                getVisual("*", myBoard.P2Row[3]), getVisual(" ", myBoard.P2Row[2]), getVisual(" ", myBoard.P2Row[1]),
                getVisual(" ", myBoard.P2Row[0]), getVisual("*", myBoard.P2Row[5]), getVisual(" ", myBoard.P2Row[4]));
            Console.WriteLine("+---+---+---+---+       +---+---+");
